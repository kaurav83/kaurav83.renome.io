...
(function () {
    ...
    function Carousel3dController($scope, $element, $attrs, $timeout, $interval, $log, $window, Carousel3dService) {
            ...
            Carousel3dService
                ...
                .then(
                    function handleResolve(carousel) {
                        ...
                        $element.css({'height': outerHeight + 50 + 'px'}); /* настраиваем высоту слайдера, для того, чтобы появился текст внизу */
        ...
        function render(animate, speedTime) {
            ...
            /* в visibility и opacity менял параметры */
        ...
        function setCss(i, zIndex, positive) {
            ...
            var leftRemain = (carousel3d.space == "auto") ? parseInt((i + 1) * (carousel3d.width / 1.5)) : parseInt((i + 0) * (carousel3d.space)),
                transform = (positive) ?
                ...
                width = "100%",   /* тут можно изменить ширину текста */
                height = "auto",
                overflow = "visible";
    ...
    function Carousel3dService($rootScope, $q, $log) {
        ...
        Carousel3d.build = function (model, params) {
            ...
            return carousel.load().promise.then(function () {
                ...
                carousel.currentIndex = carousel.startSlide > carousel.total - 1 ? carousel.total - 2 : params.startSlide;
